...
class CustomResponse:
    ...
    def base_add(self,triggers,responses):
        return self._slack.api_call("slackbot.responses.add",triggers=triggers,responses=responses)
    def base_delete(self,delid):
        return self._slack.api_call("slackbot.responses.delete",response=delid)
    def base_edit(self,editid,triggers,responses):
        return self._slack.api_call("slackbot.responses.edit",response=editid,triggers=triggers,responses=responses)
